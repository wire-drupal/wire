...
export default function () {
    store.registerHook('interceptWireModelAttachListener', (directive, el, component) => {
        ...
        let start = () => el.dispatchEvent(new CustomEvent('wire-upload-start', { bubbles: true }))
        let finish = () => el.dispatchEvent(new CustomEvent('wire-upload-finish', { bubbles: true }))
        let error = () => el.dispatchEvent(new CustomEvent('wire-upload-error', { bubbles: true }))
